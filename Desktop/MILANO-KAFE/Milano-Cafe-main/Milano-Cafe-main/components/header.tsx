                 ...
                 <div className="flex flex-col gap-6 py-6">
                  <div className="flex items-center justify-between">
                    <Link href="/" onClick={() => setIsOpen(false)} className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col leading-tight">
                        <span className="font-serif font-bold text-amber-900">MILANO</span>
                        <span className="text-xs font-light text-amber-700">KAFE</span>
                      </div>
                    </Link>
                  </div>
                      ...
                      <>
                        ...
                        {adminNavigation.map((item) => (
                          <Link
                            ...
                            onClick={() => setIsOpen(false)}
                            className={cn(
                              "flex items-center gap-2 text-base font-medium transition-colors hover:text-primary bg-primary/5 px-3 py-2 rounded-lg",
                              pathname === item.href ? "text-primary" : "text-foreground/80",
                            )}
                          >
