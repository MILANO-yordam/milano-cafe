...
import { Coffee, Home, LogOut, Menu, Bell, Zap, Package, ShoppingBag, Mail, Users, Settings } from "lucide-react"
            ...
            <nav className="flex-1 space-y-2 px-4 py-6">
                {adminNavigation.map((item) => (
                    <Link
                        key={item.name}
                        href={item.href}
                        className={`flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium transition-all ${item.href === "/admin/settings"
