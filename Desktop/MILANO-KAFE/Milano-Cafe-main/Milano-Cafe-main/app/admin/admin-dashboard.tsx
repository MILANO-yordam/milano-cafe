            ...
            <div className="lg:pl-72">
                ...
                <div className="fixed top-20 right-4 z-50 space-y-3 max-w-sm">
                    {notifications.map((notification) => (
                        <div
                            key={notification.id}
                            className={`rounded-xl shadow-2xl p-5 flex items-start justify-between gap-4 animate-in slide-in-from-right duration-300 border-2 ${notification.type === "order"
                        ...
                        >
                            <div className="flex items-start gap-3 flex-1">
                                <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${notification.type === "order"
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className={`font-semibold text-sm ${notification.type === "order" ? "text-green-900 dark:text-green-100" : "text-blue-900 dark:text-blue-100"
                                        }`}>
                                        {notification.title}
                                    </p>
                                    <p className={`text-xs mt-1 truncate ${notification.type === "order" ? "text-green-700 dark:text-green-300" : "text-blue-700 dark:text-blue-300"
                                        }`}>
                ...
                <main className="p-6 lg:p-8">
                    ...
                    {/* Stats */}
                    <div className="mb-8 grid gap-4 sm:gap-6 grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-5">
                        <Card className="shadow-card hover:shadow-elevated transition-all border-0 bg-gradient-to-br from-white to-blue-50 dark:from-slate-800 dark:to-blue-900/30">
                            <CardContent className="flex items-center gap-2 sm:gap-4 p-4 sm:p-6">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Mahsulotlar</p>
                                    <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-50">{stats.productsCount}</p>
                                </div>
                            </CardContent>
                        </Card>

                        <Card className="shadow-card hover:shadow-elevated transition-all border-0 bg-gradient-to-br from-white to-purple-50 dark:from-slate-800 dark:to-purple-900/30">
                            <CardContent className="flex items-center gap-2 sm:gap-4 p-4 sm:p-6">
                                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-purple-200 to-purple-100 dark:from-purple-900 dark:to-purple-800">
                                    <ShoppingBag className="h-7 w-7 text-purple-700 dark:text-purple-300" />
                                </div>
                                <div className="min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Kategoriyalar</p>
                                    <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-50">{stats.categoriesCount}</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="shadow-card hover:shadow-elevated transition-all border-0 bg-gradient-to-br from-white to-green-50 dark:from-slate-800 dark:to-green-900/30">
                            <CardContent className="flex items-center gap-2 sm:gap-4 p-4 sm:p-6">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Buyurtmalar</p>
                                    <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-50">{stats.ordersCount}</p>
                                </div>
                            </CardContent>
                        </Card>

                        <Card className="shadow-card hover:shadow-elevated transition-all border-0 bg-gradient-to-br from-white to-amber-50 dark:from-slate-800 dark:to-amber-900/30">
                            <CardContent className="flex items-center gap-2 sm:gap-4 p-4 sm:p-6">
                                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-amber-200 to-amber-100 dark:from-amber-900 dark:to-amber-800">
                                    <Mail className="h-7 w-7 text-amber-700 dark:text-amber-300" />
                                </div>
                                <div className="min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Yangi xabarlar</p>
                                    <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-50">{stats.messagesCount}</p>
                                </div>
                            </CardContent>
                        </Card>

                        <Card className="shadow-card hover:shadow-elevated transition-all border-0 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-slate-800 dark:to-orange-900/30">
                            <CardContent className="flex items-center gap-2 sm:gap-4 p-4 sm:p-6">
                                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-orange-300 to-amber-200 dark:from-orange-900 dark:to-amber-800">
                                    <TrendingUp className="h-7 w-7 text-orange-800 dark:text-orange-300" />
                                </div>
                                <div className="min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Umumiy daromad</p>
                                    <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-50">{formatPrice(stats.totalRevenue)}</p>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
